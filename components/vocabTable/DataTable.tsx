...
export function DataTable<TData, TValue>({
  ...
  const deleteAllVocab = async () => {
    const {
      data: { user },
    } = await supabase.auth.getUser();
    await supabase.from("user_vocabs").delete().eq("user_id", user!.id);
    toast.success("All vocabs are deleted!");
    router.refresh();
  };
